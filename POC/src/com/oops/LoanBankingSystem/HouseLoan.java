...
public class HouseLoan extends Loan {
	...
	public static void main(String[] args) {
		System.out.println("Welcome to House Loan Banking");

		System.out.println("Enter your Cibil Score");
		int cibil = sc.nextInt();

		HouseLoan l1 = new HouseLoan();

		double roi = l1.getCalculateROI(cibil);
		double salary = l1.getSalary();
		int age = l1.getAge();
		if (salary >= 500000 && age >= 26 && (cibil >= 300 && cibil <= 900)) {
			...
			if (l1.isAadhaarValid() && l1.isPanValid() && l1.isPhoneValid()) {
				...
				System.out.println("Your House Loan ROI is : " + roi);
			} else {
				System.out.println("Something went wrong!");
			}
		} else {
			System.out.println("You are not elligible for House Loan, your request is rejected");
		}
	}
}
